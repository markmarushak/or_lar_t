                                                            ...
                                                            <div class="qfb-tabs-panel">
                                                                ...
                                                                <div class="qfb-settings">
                                                                    ...
                                                                    <div class="qfb-setting<?php echo $builder->getFormConfigValue($form, 'responsiveElements') != 'custom' ? ' qfb-hidden' : ''; ?>">
                                                                        <div class="qfb-setting-label">
                                                                            <div class="qfb-tooltip-icon"><div class="qfb-tooltip-content"><?php printf(esc_html__('Enter a width using any CSS unit, for example: %s', 'quform'), '<code>600px</code>'); ?></div></div>
                                                                        ...
                                                                        <div class="qfb-setting-inner">
                                                                            <div class="qfb-setting-input">
                                                                                <select id="qfb_form_position">
                                                                                    <option value=""><?php esc_html_e('Left', 'quform'); ?></option>
                                                                                    <option value="center"><?php esc_html_e('Center', 'quform'); ?></option>
                                                                                    <option value="right"><?php esc_html_e('Right', 'quform'); ?></option>
                                                                                </select>
                                                                            </div>
                                                                        </div>
                                                                    </div>
