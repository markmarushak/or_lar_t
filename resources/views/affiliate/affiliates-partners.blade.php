                ...
                <div class="row">
                                                ...
                                                <table class="table table-striped- table-bordered table-hover table-checkable dataTable no-footer dtr-inline"
                                                    ...
                                                    <tr role="row">
                                                        ...
                                                        <th data-field="OrderID"
                                                            ...
                                                            tabindex="0" aria-controls="m_table_1" rowspan="1"
                                                            colspan="1" style="width: 187.5px;" aria-sort="descending"
                                                            aria-label="
                    ...
                    : activate to sort column ascending">
                                                        ...
                                                        <th data-field="Category"
                                                            ...
                                                            tabindex="0" aria-controls="m_table_1" rowspan="1"
                                                            colspan="1" style="width: 109.5px;" aria-label="
                        Category
                    : activate to sort column ascending">
                                                        ...
                                                        <th data-field="Website"
                                                            class="m-datatable__cell m-datatable__cell--sort sorting"
                                                            tabindex="0" aria-controls="m_table_1" rowspan="1"
                                                            colspan="1" style="width: 62.5px;" aria-label="
                        Source
                    : activate to sort column ascending">
                                                        ...
                                                        <th data-field="Department"
                                                            class="m-datatable__cell m-datatable__cell--sort sorting"
                                                            tabindex="0" aria-controls="m_table_1" rowspan="1"
                                                            colspan="1" style="width: 45.5px;" aria-label="
                        Type
                    : activate to sort column ascending">
                                                        ...
                                                        <th data-field="ShipDate"
                                                            class="m-datatable__cell m-datatable__cell--sort sorting"
                                                            tabindex="0" aria-controls="m_table_1" rowspan="1"
                                                            colspan="1" style="width: 36.5px;" aria-label="
                        Edit
                    : activate to sort column ascending">
                                                        ...
                                                        <th data-field="Actions"
                                                            class="m-datatable__cell m-datatable__cell--sort sorting"
                                                            tabindex="0" aria-controls="m_table_1" rowspan="1"
                                                            colspan="1" style="width: 58.5px;" aria-label="
                        Status
                    : activate to sort column ascending">
                                                        ...
                                                        <th data-field="Country"
                                                            class="m-datatable__cell m-datatable__cell--sort sorting"
                                                            tabindex="0" aria-controls="m_table_1" rowspan="1"
                                                            colspan="1" style="width: 73.5px;" aria-label="
                        Country
                    : activate to sort column ascending">
                            ...
                            <span style="width: 70px;"><a
                                    ...
                                    <span class="m-badge  m-badge--success m-badge--wide">active</span>
                                                    ...
                                                    <tr role="row" class="even">
                                                        ...
                                                        <td class="sorting_1">
                                                            <span style="width: 130px;">Garasje-Tilbud.no</span>
                                                        </td>
                                                        ...
                                                        <td>
                            <span style="width: 70px;"><a
                                        href="http://127.0.0.1:8000/affiliate-service/data-filters-rules/edit/1/Garasje-Tilbud.no/connection">
                                    edit
                                </a></span>
                                                        </td>
