...
class Quform_Session
{
    ...
    public function start()
    {
        ...
        $this->lifetime = apply_filters('quform_session_cookie_lifetime', 86400); // 24 hours in seconds
    ...
    {
        Quform::setCookie($this->name, $id, time() + $this->lifetime, apply_filters('quform_session_cookie_secure', false));
    }
     ...
     *
     * @param  $key    The key within the session data
