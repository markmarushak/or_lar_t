...
class Quform_Admin_Page_Forms_Edit extends Quform_Admin_Page
{
    ...
    protected function enqueueStyles()
    {
        ...
        wp_enqueue_style('select2', Quform::url('css/select2.min.css'), array(), '4.0.5');
    ...
    protected function enqueueScripts()
    {
        ...
        wp_enqueue_script('jeditable', Quform::adminUrl('js/jquery.jeditable.min.js'), array('jquery'), '1.7.3', true);
        ...
        wp_enqueue_script('select2', Quform::url('js/select2.min.js'), array('jquery'), '4.0.5', true);
        ...
        wp_enqueue_script('kendo-data', Quform::url('js/kendo.data.min.js'), array('kendo-core'), '2017.3.1026', true);
        wp_enqueue_script('kendo-tabstrip', Quform::url('js/kendo.tabstrip.min.js'), array('kendo-data'), '2017.3.1026', true);
        wp_enqueue_script('kendo-userevents', Quform::url('js/kendo.userevents.min.js'), array('kendo-core'), '2017.3.1026', true);
        wp_enqueue_script('kendo-draganddrop', Quform::url('js/kendo.draganddrop.min.js'), array('kendo-core', 'kendo-userevents'), '2017.3.1026', true);
        wp_enqueue_script('kendo-resizable', Quform::url('js/kendo.resizable.min.js'), array('kendo-core', 'kendo-draganddrop'), '2017.3.1026', true);
        wp_enqueue_script('kendo-splitter', Quform::url('js/kendo.splitter.min.js'), array('kendo-resizable'), '2017.3.1026', true);
    ...
    public function process()
    {
        ...
        if ( ! $this->license->isValid()) {
            $this->addMessage('error', '<strong>' . sprintf(esc_html__('You are using an unlicensed version. Please %senter your license key%s or %spurchase a license key%s.', 'quform'), '<a href="' . esc_url(admin_url('admin.php?page=quform.settings#license-updates')) .'">', '</a>', '<a href="http://www.quform.com/buy.php"  target="_blank">', '</a>') . '</strong>');
        }
