...
class Quform_Container extends JuiceContainer
{
    ...
    protected function setup()
    {
        ...
        $this['formProcessor'] = new JuiceDefinition('Quform_Form_Processor', array('@repository', '@session', '@uploader'));
        ...
        $this['scriptLoader'] = new JuiceDefinition('Quform_ScriptLoader', array('@options', '@themes', '@repository', '@formFactory'));
        ...
        $this['entryProcessor'] = new JuiceDefinition('Quform_Entry_Processor', array('@repository', '@session', '@uploader'));
        ...
        $this['formImporter'] = new JuiceDefinition('Quform_Form_Importer', array('@repository', '@scriptLoader'));
        ...
        $this['upgrader'] = new JuiceDefinition('Quform_Upgrader');
